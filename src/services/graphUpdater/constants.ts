...
export const DESTINATION_NOISE_RE =
  /之外|其他时间|这座城|这座城市|城市里|到场|pre|汇报|报告|论文|会议|参加一个|必须|想逛|逛一逛|计划|安排|一天|两天|三天|四天|五天|六天|七天|八天|之前|之后|然后|并且|但是|同时|顺带|顺便|顺路|顺道|其中|其中有|其余|其他时候|海地区|该地区/i;

export const PLACE_STOPWORD_RE =
  /我|你|他|她|我们|你们|他们|除了|其他|其中|其中有|其余|时间|必须|到场|之前|之后|然后|安排|计划|参加|会议|汇报|报告|pre|chi|天|行程|顺带|顺便|顺路|顺道|海地区|该地区/i;
